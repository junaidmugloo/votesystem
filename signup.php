...
<div class="login-box">
      ...
      <div class="form-group has-feedback">
          ...
          <div class="form-group has-feedback">
      		...
      		<div class="form-group has-feedback">
        		<input type="number" class="form-control" name="voter" placeholder="Mobile Number" id="phoneNumber" required>
        		<span class="glyphicon glyphicon-phone form-control-feedback"></span>
      		</div>
			  <div class="form-group has-feedback">
        		<input type="number" class="form-control" name="voter" id="email" placeholder="Aadhaar Number" minlength="12" maxlength="12" required>
